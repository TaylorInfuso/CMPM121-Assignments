...
public class PlayerMovement2 : MonoBehaviour {
    ...
    void Update () {
        ...
        if (flat == false)
        {
            ...
            //character.transform.rotation = Quaternion.Slerp(character.transform.rotation, Quaternion.Euler(0, rotationLeftAndRight / Mathf.PI * 180, 0), Time.deltaTime * 10.0f);
        }
        else if (flat == true)
        {
